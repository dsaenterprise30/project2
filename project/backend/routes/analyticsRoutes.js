...
import { getClickAnalytics, getUserInterests, getLeadsByBuilder, getLeadsByBuilderSelf } from "../controllers/analyticsController.js";
...
router.get("/my-leads", verifyAccessToken, getLeadsByBuilderSelf);
